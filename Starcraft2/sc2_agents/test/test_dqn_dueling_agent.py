import unittest
from sc2_agents.dqn_dueling_agent import DQNDuelingCNN, DQNDuelingAgent
...
class TestDQN(unittest.TestCase):
  ...
  def setUp(self):
    self.dqn = DQNDuelingCNN()
    self.agent = DQNDuelingAgent()
  ...
  def test_DQN(self):
    ...
    self.assertEqual(1, output.size()[1])
    self.assertEqual(28, output.size()[2])
    self.assertEqual(28, output.size()[3])
